...
import cstuff.ClassCreatorPattern;
import graphvizcreator.AbstractPatternDrawer;
import umlentities.IDrawer;
import umlentities.IUMLEntity;

public class LawDemeterPatternDrawer extends AbstractPatternDrawer {

	public LawDemeterPatternDrawer() {
	}

	public LawDemeterPatternDrawer(IDrawer drawer, IUMLEntity pattern) {
		super(drawer, pattern);
	}
	
	@Override
	public String draw() {
		LawDemeterPattern pat = (LawDemeterPattern) this.getEntity();
